...
const CTAS = [
  ...
  `GitHub stars are welcomed! ${A("https://github.com/Quick-AI-LLC/AI-Technical-Readout", "AI Technical Readout on GitHub")}`,
  ...
  `Export your reading as markdown or HTML — Save As picks the folder.`,
